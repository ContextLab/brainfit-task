var postSurveyTask = function() {
    ...
    //
    // The following sections were of moderate difficulty (check all that apply):
    // The following sections were easy (check all that apply):
    // The following sections were difficult (check all that apply):
    //
