...
var auth_url = 'https://fitbit.com/oauth2/authorize?response_type=code&client_id=' + client_id +'&scope=' + scope + '&prompt=' + prompt_flag + '&expires_in=' + expires_in //+ "'&redirect_uri='+ redirect_uri + &state="+state
