var screeningPages = function() {
    ...
    var instructions_main = {
        type: 'instructions',
        pages: ['<h1> Thank you for participating in our study! </h1> <p> The purpose of this study is to better understand how fitness impacts several domains of memory. </p><p>First, you will be asked a few questions about you and your daily habits so we can better understand the data we are gathering.</p><p> Next, you will be presented with several short memory tasks, with task-specific instructions provided at the start of each section. </p>',
        '<h1>Task Overview </h1> <p> The first task involves learning and reciting aloud words from visually-presented word lists. </p> <p> The second task requires viewing a short movie, reciting what you recall from the video, and answering questions on the video content. </p> <p> The third task involves remembering vocabulary-image pairs, while the fourth uses drag and drop clicks to rearrange shapes on the screen to match a presented arrangement of icons. </p><p> The entire experiment should take approximately 20-30 minutes. Please press Next > to proceed to the initial screening section. </p>', ],
