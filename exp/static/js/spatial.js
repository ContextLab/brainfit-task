    ...
    for (var i = minSpatialNumber-1; i< maxSpatialNumber; i++){ //select in config file
      for (var r = 0; r < spatialReps; r++){
        ...
        var instructions_spatial_trial = {
            type: 'instructions',
            pages: ['<p>You will now see <b>' + (i+1) + '</b> symbols within a black box.  This image will be displayed for ' + spatialPresTime + " seconds. Try your best to remember the locations of each of these icons! Press the button when you're ready.</p>"],
            show_clickable_nav: true,
        };
