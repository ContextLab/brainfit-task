var delayRecallMovieTask = function() {
    ...
    //   }
     ...
     var delayRecall_movie = {
           ...
           questions: [{prompt: "The timer has started! Please recall the story in the box below within the next " + (movieRecallSecs/60) + " minutes.<br/><p><b>Type enter/return, '.', '!', or '?' to submit each sentence.</b></p>", value: '', recall_mode: 'narrative'}],
           data: {
