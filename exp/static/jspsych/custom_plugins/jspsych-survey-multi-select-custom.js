/**
 * jspsych-survey-multi-select-custom
...
jsPsych.plugins['survey-multi-select-custom'] = (function() {
  var plugin = {};

  plugin.info = {
    name: 'survey-multi-select-custom',
    description: '',
    parameters: {
      questions: {
  ...
  plugin.trial = function(display_element, trial) {
    var plugin_id_name = "jspsych-survey-multi-select-custom";
    ...
    display_element.innerHTML = '<style id="jspsych-survey-multi-select-custom-css"></style>';
    var cssstr = ".jspsych-survey-multi-select-custom-question { margin-top: 2em; margin-bottom: 2em; text-align: left; }"+
      ".jspsych-survey-multi-select-custom-text span.required {color: darkred;}"+
      ".jspsych-survey-multi-select-custom-horizontal .jspsych-survey-multi-select-custom-text {  text-align: center;}"+
      ".jspsych-survey-multi-select-custom-option { line-height: 2; }"+
      ".jspsych-survey-multi-select-custom-horizontal .jspsych-survey-multi-select-custom-option {  display: inline-block;  margin-left: 1em;  margin-right: 1em;  vertical-align: top;}"+
      "label.jspsych-survey-multi-select-custom-text input[type='checkbox'] {margin-right: 1em;}"

    display_element.querySelector('#jspsych-survey-multi-select-custom-css').innerHTML = cssstr;
    ...
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      // add question text
      display_element.querySelector(question_selector).innerHTML += '<p id="survey-question" class="' + plugin_id_name + '-text survey-multi-select-custom">' + trial.questions[i].prompt + '</p>';
